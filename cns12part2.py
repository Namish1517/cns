...
# USING CLASSICAL CRYPTOGRAPHY, MODULAR ARITHMETIC AND AES
# ============================================================
...
print(
    f"Multiplicative inverse of "
    f"{number} modulo {modulus} = {inverse}"
)

if inverse is not None:
    print(
        f"Verification: "
        f"({number} × {inverse}) mod {modulus} = "
        f"{(number * inverse) % modulus}"
    )
...
print("\n" + "-" * 70)
print("7. FERMAT'S LITTLE THEOREM")
print("-" * 70)
...
if result == 1:
    ...
    print(
        "Fermat's Little Theorem not verified."
    )
...
print("\n" + "-" * 70)
print("8. CHINESE REMAINDER THEOREM")
print("-" * 70)
